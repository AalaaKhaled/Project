...
@section('content')
  ...
  <div class="card">
    ...
    <div >
       @if($post->user->avatar)
      <img src="{{ asset('/storage/images/'.$post->user->avatar) }}" style="margin-right: 20px;margin-top: 10px;margin-left: 10px" class="avatar img-circle rounded-circle float-left" alt="avatar" width="50px" height="50px">
       @else
  ...
  <div class="card-body">
      ...
      <div style="margin-bottom: 5px">
        ...
        <a href="{{route('likes.liked',$post->id)}}" style="text-decoration: none">
         @if(in_array($post->id,$postsLiked))
    ...
    <p class="card-title" style="font-weight: bold;margin-bottom: 3px">{{$post->user->username}}</p>
